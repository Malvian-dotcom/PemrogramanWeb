...
<html lang="en">
    ...
    <body>
        ...
        <table>
            ...
            <?php
            // Mendefinisikan array multidimensi $movie
            $movie = array (
                array("Avangers: Infinity War", 2018, 8.7), array("The Avangers", 2012, 8.1),
                array("Guardian of the Galaxy", 2014, 8.1), array("Iron man", 2008, 7.9)
            );
